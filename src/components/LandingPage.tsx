...
export function LandingPage({ onGetStarted, onLoginClick }: LandingPageProps) {
  ...
  return (
    <>
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 pt-20 pb-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left side - Content */}
            <div>
              <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-700 border-2 border-purple-200 px-6 py-3 rounded-full mb-8 shadow-sm">
              ...
              <h1 className="text-purple-900 mb-6 leading-tight">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 text-slate-600">
                  ...
                  <p>
                    Vi vet at compliance ofte oppleves som en tung og
                    tidkrevende byrde, spesielt for team med begrensede
                    ressurser. Derfor har vi utviklet{" "}
                  ...
                  <p>
                    ...
                    strukturert og faktisk gjennomførbart for team på 2+
                    personer. Vi tror på at sikkerhet, kvalitet og personvern
                    ikke skal være forbeholdt store bedrifter med store
                    budsjetter.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">
                        ...
                        gjennomførbart for norske virksomheter – uansett
        ...
        <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 py-24">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <p className="text-purple-100 mb-8 text-lg">
              Få oversikt over compliance-status på minutter, ikke måneder.
              Start gratis i dag.
            </p>
      ...
      {/* Scroll to top button - outside overflow container */}
      <ScrollToTop />
    </>
  );
}
