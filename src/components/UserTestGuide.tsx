          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-slate-600">
                Strukturert testløype for konsistent og målrettet evaluering av prototypen
              </p>
            </div>
        ...
        <div className="space-y-4">
          ...
          <Card className="overflow-hidden border-2 border-purple-100">
            ...
            {(expandedSection === "scenario" || isPrintMode) && (
              <div className={isPrintMode ? "px-6 pb-6 pt-6 bg-white print-expand" : "px-6 pb-6 border-t border-purple-100 pt-6 bg-white"}>
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-6">
                  ...
                  <p className="text-slate-700 mb-4">
                    "Du er nylig ansatt som CTO i et medisinteknisk selskap med 15 ansatte. 
                    Selskapet utvikler en digital helseplattform og trenger å dokumentere 
                    compliance med ISO 27001 (informasjonssikkerhet), GDPR (personvern) og 
                    ISO 13485 (medisinteknisk kvalitet).
                  </p>
                  <p className="text-slate-700 mb-4">
                    Styret har gitt deg 3 måneder til å kartlegge nåværende compliance-status 
                    og lage en realistisk handlingsplan. Du har begrenset tid og budsjett, 
                    og trenger en effektiv måte å få oversikt på.
                  </p>
                  <p className="text-slate-700">
                    Du har hørt om Compliance-kompass og vil teste om det kan hjelpe deg med 
                    denne oppgaven."
                  </p>
                </div>

                <div className="space-y-3">
                  <h4 className="text-purple-900 mb-3">Kontekst-spørsmål (før test)</h4>
                  {[
            ...
            {(expandedSection === "tasks" || isPrintMode) && (
              <div className={isPrintMode ? "px-6 pb-6 pt-6 bg-white print-expand" : "px-6 pb-6 border-t border-purple-100 pt-6 bg-white"}>
                <p className="text-slate-600 mb-6">
                  Be brukeren om å "tenke høyt" mens de utfører oppgavene. Ikke hjelp med mindre 
                  de står fullstendig fast i mer enn 2 minutter.
                </p>
                    ...
                    <div key={idx} className="border border-slate-200 rounded-lg p-5">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-slate-500 text-sm">Estimert tid: {task.time}</p>
                        </div>
                      </div>
              ...
              <div className={isPrintMode ? "px-6 pb-6 pt-6 bg-white print-expand" : "px-6 pb-6 border-t border-purple-100 pt-6 bg-white"}>
                ...
                <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <ul className="space-y-2 text-green-800">
                    <li>• Takk deltakeren for tiden og verdifulle tilbakemeldinger</li>
                    <li>• Spør om de har noen siste kommentarer eller tanker</li>
                    <li>• Forklar hva som skjer videre med tilbakemeldingene</li>
